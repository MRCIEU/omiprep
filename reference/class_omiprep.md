...
A \`Omiprep\` object is a container for matrices of 'omics data, along
with associated metadata. It allows for efficient storage and
...
- data:
  ...
  numeric matrix, the data matrix containing 'omics values (not to be
  set directly).
