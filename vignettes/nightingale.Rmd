...
Read in the Nightingale Health data using the `read_nightingale` function. Here we will read in the example data provided with the package, and convert it directly into a Omiprep S7 object.
