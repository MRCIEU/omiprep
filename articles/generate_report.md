...
#> AF =  2
#> ✔ Sample & Feature Summary Statistics for raw data [473ms]
#> 
...
#>                         step seconds   pct
#>                   validation    0.02   1.2
#>                summarise_raw    0.46  26.9
#>                   copy_layer    0.00   0.0
#>   extreme_sample_missingness    0.00   0.0
#>  extreme_feature_missingness    0.00   0.0
#>           sample_missingness    0.00   0.0
#>              total_peak_area    0.00   0.0
#>                summarise_pca    0.53  31.0
#>              summarise_final    0.44  25.8
#>                        total    1.71 100.2
#> ✔ Creating final QC dataset... [494ms]
#> 
#> ℹ 'Omics QC Process Completed
#> ✔ 'Omics QC Process Completed [23ms]
```
