...
#> ℹ Sample & Feature Summary Statistics for raw data✔ Sample & Feature Summary Statistics for raw data [576ms]
#> 
...
#>                         step seconds  pct
#>                   validation    0.00  0.0
#>                summarise_raw    0.55 28.0
#>                   copy_layer    0.01  0.5
#>   extreme_sample_missingness    0.00  0.0
#>  extreme_feature_missingness    0.00  0.0
#>           sample_missingness    0.00  0.0
#>          total_sum_abundance    0.00  0.0
#>                summarise_pca    0.63 32.1
#>              summarise_final    0.53 27.0
#>                        total    1.96 99.9
#> ✔ Creating final QC dataset... [573ms]
#> 
