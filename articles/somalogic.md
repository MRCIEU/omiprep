...
#> ℹ Sample & Feature Summary Statistics for raw data✔ Sample & Feature Summary Statistics for raw data [372ms]
#> 
...
#>                         step seconds   pct
#>                   validation    0.00   0.0
#>                summarise_raw    0.36  28.2
#>                   copy_layer    0.00   0.0
#>   extreme_sample_missingness    0.00   0.0
#>  extreme_feature_missingness    0.00   0.0
#>           sample_missingness    0.00   0.0
#>          total_sum_abundance    0.00   0.0
#>                summarise_pca    0.42  32.9
#>              summarise_final    0.32  25.0
#>                        total    1.28 100.2
#> ✔ Creating final QC dataset... [351ms]
#> 
