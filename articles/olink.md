...
#> ℹ Sample & Feature Summary Statistics for raw data✔ Sample & Feature Summary Statistics for raw data [574ms]
#> 
...
#>                         step seconds  pct
#>                   validation    0.00  0.0
#>                summarise_raw    0.56 25.2
#>                   copy_layer    0.00  0.0
#>   extreme_sample_missingness    0.00  0.0
#>  extreme_feature_missingness    0.00  0.0
#>           sample_missingness    0.00  0.0
#>          total_sum_abundance    0.00  0.0
#>                summarise_pca    0.68 30.6
#>              summarise_final    0.77 34.6
#>                        total    2.22 99.9
#> ✔ Creating final QC dataset... [816ms]
#> 
