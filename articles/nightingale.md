...
#> ℹ Sample & Feature Summary Statistics for raw data✔ Sample & Feature Summary Statistics for raw data [83ms]
#> 
...
#>                         step seconds   pct
#>                   validation    0.00   0.0
#>                summarise_raw    0.07  16.4
#>                   copy_layer    0.00   0.0
#>   extreme_sample_missingness    0.00   0.0
#>  extreme_feature_missingness    0.00   0.0
#>           sample_missingness    0.00   0.0
#>          total_sum_abundance    0.00   0.0
#>                summarise_pca    0.14  32.8
#>              summarise_final    0.04   9.4
#>                        total    0.43 100.7
#> ✔ Creating final QC dataset... [63ms]
#> 
